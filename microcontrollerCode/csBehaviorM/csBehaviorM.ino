...
uint16_t pulseTrain_chanA[] = {0, 0, 1000, 1000, 0, 2000, 0, 0};
...
int knownValues[] = {0, 500, 5000, 0, 0, 0, 0, 1, 0, 0, 0, pulseTrain_chanA[6], pulseTrain_chanA[5], pulseTrain_chanA[3]};
int knownCount = 14;
...
void dataReport() {
  ...
  Serial.print(',');
  Serial.println(pulseTrain_chanA[7]);
}
